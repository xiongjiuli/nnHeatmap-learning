...
import dynamic_network_architectures_nndet
...
class ConfigurationManager(object):
    ...
    def UNet_class(self) -> Type[nn.Module]:
        unet_class = recursive_find_python_class(join(dynamic_network_architectures_nndet.__path__[0], "architectures"),
                                                 self.UNet_class_name,
                                                 current_module="dynamic_network_architectures_nndet.architectures")
